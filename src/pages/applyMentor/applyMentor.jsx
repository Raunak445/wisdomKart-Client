  ...
  return (
    ...
    <div>
      {!user?.isMentor ? (
          ...
          >
            <Input />
              ...
              <div className={style.subtext}>
                Highlight your credentials, achievements, and how you can help.
                We recommend you keep it between 200-500 characters{" "}
              </div>
              <Form.Item
                name="biodata"
                label="Biodata"
              ...
              >
                <Select
                  mode="multiple"
                  placeholder="Select or type to add areas"
                >
                  {areas.map((area) => (
        ...
        >
          You have already applied for Mentor
        </div>
      )}
    </div>
  );
